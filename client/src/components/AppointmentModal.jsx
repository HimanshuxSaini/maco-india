...
const AppointmentModal = ({ isOpen, onClose }) => {
 ...
 className="w-full max-w-lg max-h-[85vh] flex flex-col bg-white border border-gray-200 rounded-2xl shadow-2xl overflow-hidden pointer-events-auto"
 >
 {/* Header */}
 ...
 className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-maco-red/50 text-gray-900 placeholder-gray-500 transition-all"
 />
 </div>
 ...
 className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-maco-red/50 text-gray-900 placeholder-gray-500 transition-all resize-none"
 ></textarea>
 </div>
