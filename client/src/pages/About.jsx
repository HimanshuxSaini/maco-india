...
const About = () => {
  ...
  return (
    <div className="w-full bg-white overflow-hidden">
      {/* Hero Section */}
      <section className="relative pt-24 pb-12 lg:pt-40 lg:pb-32 bg-white overflow-hidden flex flex-col justify-center h-[100dvh] min-h-[600px] lg:h-auto lg:min-h-screen">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-20 lg:h-32 bg-gradient-to-t from-white to-transparent pointer-events-none z-10"></div>

        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center justify-center h-full">

          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="inline-flex items-center px-3 py-1.5 lg:px-4 lg:py-2 rounded-full bg-maco-red/10 border border-maco-red/20 mb-4 lg:mb-8 mx-auto"
          >
            <span className="w-2 h-2 rounded-full bg-maco-red mr-2 animate-pulse"></span>
            <span className="text-maco-red text-[10px] md:text-sm font-bold tracking-widest uppercase">About Our Company</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[5rem] font-black text-gray-900 mb-4 lg:mb-8 tracking-tight leading-[1.1]"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base md:text-xl text-gray-600 leading-relaxed font-medium max-w-3xl mx-auto mb-6 lg:mb-14"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-3 lg:gap-12 w-full"
          >
            <div className="flex items-center gap-3 bg-white/50 p-2 rounded-xl">
              <div className="flex-shrink-0 w-10 h-10 lg:w-14 lg:h-14 rounded-full bg-white shadow-md flex items-center justify-center border border-gray-100">
                <Shield className="w-5 h-5 lg:w-6 lg:h-6 text-maco-red" />
              </div>
              <div className="text-left">
                <p className="text-xs text-gray-500 font-medium leading-tight">Certified</p>
                <p className="font-bold text-gray-900 text-sm lg:text-lg leading-tight">ISO Standards</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 bg-white/50 p-2 rounded-xl">
              <div className="flex-shrink-0 w-10 h-10 lg:w-14 lg:h-14 rounded-full bg-white shadow-md flex items-center justify-center border border-gray-100">
                <Globe className="w-5 h-5 lg:w-6 lg:h-6 text-maco-red" />
              </div>
              <div className="text-left">
                <p className="text-xs text-gray-500 font-medium leading-tight">Reach</p>
                <p className="font-bold text-gray-900 text-sm lg:text-lg leading-tight">Global Markets</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 bg-white/50 p-2 rounded-xl">
              <div className="flex-shrink-0 w-10 h-10 lg:w-14 lg:h-14 rounded-full bg-maco-red shadow-lg shadow-red-500/30 flex items-center justify-center border border-red-500 text-white font-black text-sm lg:text-xl">
                70+
              </div>
              <div className="text-left">
                <p className="text-xs text-gray-500 font-medium leading-tight">Legacy</p>
                <p className="font-bold text-gray-900 text-sm lg:text-lg leading-tight">Years Experience</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        className="absolute bottom-4 lg:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center cursor-pointer group z-20"
        ...
        >
        <ChevronDown className="w-5 h-5 lg:w-6 lg:h-6 text-gray-400 lg:text-gray-900" />
        </motion.div>
        </motion.div>
      </section>
