...
const ProductDetails = () => {
 ...
 <Settings2 className="h-48 w-48 text-gray-900 " />
 )}
 </motion.div>
 ...
 >
 <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">{product.title}</h1>
 ...
 <Link to="/contact" className="inline-flex justify-center items-center px-8 py-4 border border-transparent text-lg font-medium rounded-xl text-gray-900 bg-maco-red hover:bg-red-700 transition-colors shadow-lg self-start">
 Request a Quote
 </Link>
 </motion.div>
 </div>
