      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-20">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-4">ISO Certified</h3>
          ...
          <motion.div 
            ...
            className="bg-black p-10 rounded-3xl shadow-2xl text-white transform lg:-translate-y-4 border border-maco-red/50"
          >
            <ClipboardCheck className="h-14 w-14 text-maco-red mb-6" />
            <h3 className="text-2xl font-bold mb-4 text-white">Strict Inspection</h3>
