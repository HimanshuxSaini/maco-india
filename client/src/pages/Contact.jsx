    ...
    <div className="pt-20 pb-20 bg-gray-50 dark:bg-[#0a0a0a] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className={`w-full px-4 py-3 rounded-lg border bg-white dark:bg-black/50 text-gray-900 dark:text-white ${errors.name ? 'border-red-500' : 'border-gray-200 dark:border-white/10'} focus:outline-none focus:ring-2 focus:ring-maco-red`}
              ...
              <div>
                ...
                <input 
                  ...
                  className={`w-full px-4 py-3 rounded-lg border bg-white dark:bg-black/50 text-gray-900 dark:text-white ${errors.email ? 'border-red-500' : 'border-gray-200 dark:border-white/10'} focus:outline-none focus:ring-2 focus:ring-maco-red`}
              ...
              <div>
                ...
                <input 
                  ...
                  className={`w-full px-4 py-3 rounded-lg border bg-white dark:bg-black/50 text-gray-900 dark:text-white ${errors.subject ? 'border-red-500' : 'border-gray-200 dark:border-white/10'} focus:outline-none focus:ring-2 focus:ring-maco-red`}
              ...
              <div>
                ...
                <textarea 
                  ...
                  className={`w-full px-4 py-3 rounded-lg border bg-white dark:bg-black/50 text-gray-900 dark:text-white ${errors.message ? 'border-red-500' : 'border-gray-200 dark:border-white/10'} focus:outline-none focus:ring-2 focus:ring-maco-red`}
              ...
              <button 
                ...
                className="w-full flex justify-center items-center px-8 py-4 border border-transparent text-lg font-medium rounded-xl text-gray-900 dark:text-white bg-maco-red hover:bg-red-700 transition-colors shadow-lg disabled:opacity-70 disabled:cursor-not-allowed"
              >
          ...
          >
            {/* Head Office */}
            <div className="bg-white dark:bg-black p-8 rounded-3xl shadow-xl text-gray-900 dark:text-white border border-gray-100 dark:border-white/5 hover:border-maco-red/50 transition-colors flex-1 flex flex-col group/card">
              ...
              <ul className="space-y-4 mb-8 flex-grow">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600 dark:text-gray-300">2-A/3, Asaf Ali Rd, Old Delhi, Turkman Gate, Chandni Chowk, New Delhi, Delhi, 110002</span>
                </li>
                <li className="flex items-center">
                  <Phone className="h-5 w-5 mr-3 text-maco-red shrink-0" />
                  <span className="text-gray-600 dark:text-gray-300">+91 11 23263672, 23273274</span>
                </li>
                <li className="flex items-center">
                  <Mail className="h-5 w-5 mr-3 text-maco-red shrink-0" />
                  <a href="mailto:macoho@maco-india.com" className="text-gray-600 dark:text-gray-300 hover:text-maco-red transition-colors">macoho@maco-india.com</a>
                </li>
              </ul>
